...
//description: Contains a method called passBill() which is used to pass a bill from the lok sabha by taking name of the bill and description of the bill

import java.util.Scanner;

public class LokSabha {
    final int total_members = 545;
    ...
    static void passBill() {
        ...
        if (name != null && des != null) {
            System.out.println("Lok Sabha bill\n Name: " + name + "\nDescription: " + des);
